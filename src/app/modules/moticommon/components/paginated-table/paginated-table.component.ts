...
import { SortableDirective } from 'src/app/modules/moticommon/directives/sortable.directive';
...
import { PaginationBodyDirective, PaginationHeadDirective } from '../../directives';

@Component({
  selector: 'moti-paginated-table',
