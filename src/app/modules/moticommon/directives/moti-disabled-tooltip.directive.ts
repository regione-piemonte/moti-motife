...
@Directive({
  selector: '[motiDisabledTt]'
})
export class MotiDisabledTooltipDirective extends NgbTooltip implements OnInit {

  @Input() motiDisabledTt: string;
  ...
  @HostListener('mouseenter') onMouseEnter() {
    const text = this.motiDisabledTt;
